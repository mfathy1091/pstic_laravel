            ...
            <form action="{{ route('psscases.store') }}" method="post">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <input id="direct_individual_id" type="hidden" name="direct_individual_id" class="form-control" value="{{ $individual->id }}">
                        <input id="file_id" type="hidden" name="file_id" class="form-control" value="{{ $individual->file->id }}">
